-- seed.sql — Dados 100% fictícios. NÃO reutilize essas senhas em lugar nenhum.
-- Senhas gravadas como SHA-256 (SHA2(texto,256)); o Node calcula o mesmo hash.
-- Login de teste (usuário -> senha):
--   admin -> admin123 | joana.silva -> senha123 | carlos.souza -> mudar@2024
--   mariana.lima -> boasenha! | pedro.alves -> pedrinho99
